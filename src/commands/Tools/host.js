...
export default {
    ...
    async execute(interaction) {
        ...
        if (tipo === 'host') {
            textoTraducido = `<@${usuarioStaff.id}> ahora es el **Host** de la sesión actual. ¡Dirígete a este usuario si tienes alguna duda o inconveniente dentro del servidor!`;
        } else if (tipo === 'cohost') {
            textoTraducido = `<@${usuarioStaff.id}> ahora es **Co-Host** de la sesión actual. ¡Dirígete a este usuario si el host está ocupado o no se encuentra disponible!`;
        }
