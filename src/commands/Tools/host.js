...
export default {
    ...
    async execute(interaction) {
        ...
        const titulo = esCohost
            ...
            : `${E.2alas} **00Y4n Southwest Florida Comunidad** — **Host de Sesión** ${E.2alas}`;
        ...
        const descripcion = esCohost
            ...
            : `${E.dot} <@${usuarioStaff.id}> **es el Host de la sesión actual**. Dirigite a este usuario si tenés dudas o inconvenientes dentro del servidor.`;
